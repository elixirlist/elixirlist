...
config :elixir_list, ElixirListWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: ElixirListWeb.ErrorHTML, json: ElixirListWeb.ErrorJSON],
    layout: false
  ],
...
config :elixir_list, ElixirList.Mailer, adapter: Swoosh.Adapters.Local
